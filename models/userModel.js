...
const userNameLengthMessage = 'Username length must be between 2 and 20 characters';
const passwordLengthMessage = 'Password length must be between 4 and 30 characters';
const standardCharactersMessage = 'Only A-Z; a-z; А-Я; а-я; !@#$%^&*()_+ are acceptable';
